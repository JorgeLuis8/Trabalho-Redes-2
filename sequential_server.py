...
def processar_requisicao(data):
    ...
    if metodo == "GET":
        return montar_resposta("200 OK", "<h1>Servidor Sequencial - GET</h1>")
    elif metodo == "POST":
        return montar_resposta("201 Created", "<h1>Servidor Sequencial - POST</h1>")
    elif metodo == "PUT":
        return montar_resposta("200 OK", "<h1>Servidor Sequencial - PUT</h1>")
    else:
